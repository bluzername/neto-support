# קבלה בשנייה (Kabala) - Privacy Policy / מדיניות פרטיות

Last updated: 2026-09-06

## עברית

קבלה בשנייה אינה אוספת, שומרת או משדרת מידע אישי מכל סוג.

- אין חשבון משתמש, אין הרשמה.
- אין קריאות רשת. האפליקציה פועלת כולה על המכשיר, ללא שרתים.
...
Kabala does not collect, store or transmit personal data of any kind.

- No user account, no sign-up.
- No network calls. The app runs entirely on the device, with no servers.
