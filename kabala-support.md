# קבלה בשנייה (Kabala) - Support / תמיכה

## עברית

קבלה בשנייה היא אפליקציית משרד אחורי לעצמאים בישראל: צילום קבלות עם בדיקת מע"מ ומספר הקצאה, דוח מע"מ תקופתי עם ייצוא CSV, והצעות מחיר ב-PDF. הכול על המכשיר.
...
Kabala is a back-office app for Israeli freelancers: receipt capture with VAT and allocation-number checks, a periodic VAT return with CSV export, and PDF price quotes. Everything runs on the device.
